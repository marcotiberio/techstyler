...
function registerInnovatorPostType()
{
    $labels = [
        'name'                  => _x('Innovator Spotlights', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Innovator Spotlight', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Innovator Spotlights', 'flynt'),
        'name_admin_bar'        => __('Innovator Spotlight', 'flynt'),
    ...
    $args = [
        ...
        'description'           => __('Innovator Spotlight Description', 'flynt'),
        'labels'                => $labels,
        'supports'              => ['title'],
        'taxonomies'            => [''],
        'hierarchical'          => false,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerInnovatorPostType');
